...
class PositionCommand {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('use_msg_gains_flags')) {
        this.use_msg_gains_flags = initObj.use_msg_gains_flags
      }
      else {
        this.use_msg_gains_flags = 0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [use_msg_gains_flags]
    bufferOffset = _serializer.uint8(obj.use_msg_gains_flags, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [use_msg_gains_flags]
    data.use_msg_gains_flags = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.use_msg_gains_flags !== undefined) {
      resolved.use_msg_gains_flags = msg.use_msg_gains_flags;
    }
    else {
      resolved.use_msg_gains_flags = 0
    }
