...
(cl:defmethod cl:initialize-instance :after ((m <Corrections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Corrections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_msgs-msg:<Corrections> is deprecated: use kr_mav_msgs-msg:Corrections instead.")))
