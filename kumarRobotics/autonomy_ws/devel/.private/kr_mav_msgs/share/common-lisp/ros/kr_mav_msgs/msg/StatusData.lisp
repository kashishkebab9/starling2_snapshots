...
(cl:defmethod cl:initialize-instance :after ((m <StatusData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StatusData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_msgs-msg:<StatusData> is deprecated: use kr_mav_msgs-msg:StatusData instead.")))
