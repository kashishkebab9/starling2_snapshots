...
(cl:defclass <TRPYCommand> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (aux
    :reader aux
    :initarg :aux
    :type kr_mav_msgs-msg:AuxCommand
    :initform (cl:make-instance 'kr_mav_msgs-msg:AuxCommand)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TRPYCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TRPYCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_msgs-msg:<TRPYCommand> is deprecated: use kr_mav_msgs-msg:TRPYCommand instead.")))
...
(cl:defmethod thrust-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:thrust-val is deprecated.  Use kr_mav_msgs-msg:thrust instead.")
  (thrust m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:roll-val is deprecated.  Use kr_mav_msgs-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:pitch-val is deprecated.  Use kr_mav_msgs-msg:pitch instead.")
  (pitch m))
...
(cl:defmethod angular_velocity-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:angular_velocity-val is deprecated.  Use kr_mav_msgs-msg:angular_velocity instead.")
  (angular_velocity m))

(cl:ensure-generic-function 'kR-val :lambda-list '(m))
(cl:defmethod kR-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:kR-val is deprecated.  Use kr_mav_msgs-msg:kR instead.")
  (kR m))

(cl:ensure-generic-function 'kOm-val :lambda-list '(m))
(cl:defmethod kOm-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:kOm-val is deprecated.  Use kr_mav_msgs-msg:kOm instead.")
  (kOm m))

(cl:ensure-generic-function 'aux-val :lambda-list '(m))
(cl:defmethod aux-val ((m <TRPYCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:aux-val is deprecated.  Use kr_mav_msgs-msg:aux instead.")
  (aux m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TRPYCommand>)))
  ...
  (cl:format cl:nil "Header header~%float64 thrust~%float64 roll~%float64 pitch~%float64 yaw~%geometry_msgs/Vector3 angular_velocity~%float64[3] kR~%float64[3] kOm~%kr_mav_msgs/AuxCommand aux~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: kr_mav_msgs/AuxCommand~%float64 current_yaw~%float64 kf_correction~%float64[2] angle_corrections # Trims for roll, pitch~%bool enable_motors~%bool use_external_yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TRPYCommand)))
  "Returns full string definition for message of type 'TRPYCommand"
  (cl:format cl:nil "Header header~%float64 thrust~%float64 roll~%float64 pitch~%float64 yaw~%geometry_msgs/Vector3 angular_velocity~%float64[3] kR~%float64[3] kOm~%kr_mav_msgs/AuxCommand aux~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: kr_mav_msgs/AuxCommand~%float64 current_yaw~%float64 kf_correction~%float64[2] angle_corrections # Trims for roll, pitch~%bool enable_motors~%bool use_external_yaw~%~%~%"))
