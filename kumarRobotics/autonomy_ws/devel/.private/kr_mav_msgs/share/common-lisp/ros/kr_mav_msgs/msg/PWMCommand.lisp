...
(cl:defmethod cl:initialize-instance :after ((m <PWMCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PWMCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_msgs-msg:<PWMCommand> is deprecated: use kr_mav_msgs-msg:PWMCommand instead.")))
...
(cl:defmethod pwm-val ((m <PWMCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kr_mav_msgs-msg:pwm-val is deprecated.  Use kr_mav_msgs-msg:pwm instead.")
  (pwm m))
