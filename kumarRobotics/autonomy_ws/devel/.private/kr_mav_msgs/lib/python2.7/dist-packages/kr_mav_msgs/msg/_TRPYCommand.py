...
"""autogenerated by genpy from kr_mav_msgs/TRPYCommand.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','float64','float64','float64','geometry_msgs/Vector3','float64[3]','float64[3]','kr_mav_msgs/AuxCommand']
