...
"""autogenerated by genpy from kr_mav_msgs/SO3Command.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','geometry_msgs/Vector3','kr_mav_msgs/AuxCommand','float64[3]','float64[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.aux is None:
        self.aux = kr_mav_msgs.msg.AuxCommand()
      if self.kR is None:
        self.kR = [0.] * 3
      if self.kOm is None:
        self.kOm = [0.] * 3
