...
"""autogenerated by genpy from kr_mav_msgs/PositionCommand.msg. Do not edit."""
import codecs
import sys
...
class PositionCommand(genpy.Message):
  _md5sum = "0311a8eaed8b83c776def91b77632ae6"
  _type = "kr_mav_msgs/PositionCommand"
...
float64 z"""
  ...
  __slots__ = ['header','position','velocity','acceleration','jerk','yaw','yaw_dot','kx','kv','use_msg_gains_flags']
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','float64','float64','float64[3]','float64[3]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,position,velocity,acceleration,jerk,yaw,yaw_dot,kx,kv,use_msg_gains_flags
    ...
    if args or kwds:
      ...
      if self.kv is None:
        self.kv = [0.] * 3
      if self.use_msg_gains_flags is None:
        self.use_msg_gains_flags = 0
    else:
      self.header = std_msgs.msg.Header()
      self.position = geometry_msgs.msg.Point()
      self.velocity = geometry_msgs.msg.Vector3()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.use_msg_gains_flags,) = _get_struct_B().unpack(str[start:end])
      return self
