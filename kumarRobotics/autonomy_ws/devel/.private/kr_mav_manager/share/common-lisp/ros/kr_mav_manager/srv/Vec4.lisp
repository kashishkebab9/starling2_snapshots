...
(cl:defmethod cl:initialize-instance :after ((m <Vec4-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vec4-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_manager-srv:<Vec4-request> is deprecated: use kr_mav_manager-srv:Vec4-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Vec4-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vec4-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_mav_manager-srv:<Vec4-response> is deprecated: use kr_mav_manager-srv:Vec4-response instead.")))
