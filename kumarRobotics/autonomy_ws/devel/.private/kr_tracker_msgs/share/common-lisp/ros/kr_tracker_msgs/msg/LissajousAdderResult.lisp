...
;//! \htmlinclude LissajousAdderResult.msg.html

(cl:defclass <LissajousAdderResult> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass LissajousAdderResult (<LissajousAdderResult>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LissajousAdderResult>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LissajousAdderResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kr_tracker_msgs-msg:<LissajousAdderResult> is deprecated: use kr_tracker_msgs-msg:LissajousAdderResult instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <LissajousAdderResult>))
...
(cl:defmethod y-val ((m <LissajousAdderResult>))
...
(cl:defmethod z-val ((m <LissajousAdderResult>))
...
(cl:defmethod yaw-val ((m <LissajousAdderResult>))
...
(cl:defmethod duration-val ((m <LissajousAdderResult>))
...
(cl:defmethod length-val ((m <LissajousAdderResult>))
  ...
  (length m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LissajousAdderResult>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LissajousAdderResult>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LissajousAdderResult>)))
  "Returns string type for a message object of type '<LissajousAdderResult>"
  "kr_tracker_msgs/LissajousAdderResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LissajousAdderResult)))
  "Returns string type for a message object of type 'LissajousAdderResult"
  "kr_tracker_msgs/LissajousAdderResult")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LissajousAdderResult>)))
  "Returns md5sum for a message object of type '<LissajousAdderResult>"
  "4ded8f5612bed1e7951000cd5b755c5f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LissajousAdderResult)))
  "Returns md5sum for a message object of type 'LissajousAdderResult"
  "4ded8f5612bed1e7951000cd5b755c5f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LissajousAdderResult>)))
  "Returns full string definition for message of type '<LissajousAdderResult>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LissajousAdderResult)))
  "Returns full string definition for message of type 'LissajousAdderResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#result definition~%# send back goal~%float64 x~%float64 y~%float64 z~%float64 yaw~%# time duration of the trajectory~%float64 duration~%# approximate arc length of the trajectory (ie. sum of distances between position commands)~%float64 length~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LissajousAdderResult>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LissajousAdderResult>))
  "Converts a ROS message object to a list"
  (cl:list 'LissajousAdderResult
    (cl:cons ':x (x msg))
    (cl:cons ':y (y msg))
    (cl:cons ':z (z msg))
    (cl:cons ':yaw (yaw msg))
