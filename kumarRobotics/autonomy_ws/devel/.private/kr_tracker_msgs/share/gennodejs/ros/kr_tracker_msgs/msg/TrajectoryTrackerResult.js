...
class TrajectoryTrackerResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryTrackerResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryTrackerResult(null);
...
module.exports = TrajectoryTrackerResult;
