...
class PolyTrackerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PolyTrackerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PolyTrackerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PolyTrackerActionFeedback(null);
    ...
    data.feedback = PolyTrackerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PolyTrackerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PolyTrackerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PolyTrackerFeedback()
    }
...
module.exports = PolyTrackerActionFeedback;
