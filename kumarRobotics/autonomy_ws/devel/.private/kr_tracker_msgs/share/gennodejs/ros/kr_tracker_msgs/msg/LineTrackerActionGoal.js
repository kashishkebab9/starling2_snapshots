...
class LineTrackerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LineTrackerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LineTrackerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LineTrackerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LineTrackerGoal()
    }
...
module.exports = LineTrackerActionGoal;
