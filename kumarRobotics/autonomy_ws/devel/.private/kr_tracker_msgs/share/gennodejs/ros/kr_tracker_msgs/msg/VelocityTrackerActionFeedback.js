...
class VelocityTrackerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new VelocityTrackerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = VelocityTrackerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VelocityTrackerActionFeedback(null);
    ...
    data.feedback = VelocityTrackerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VelocityTrackerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = VelocityTrackerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new VelocityTrackerFeedback()
    }
...
module.exports = VelocityTrackerActionFeedback;
