...
class PolyTrackerActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PolyTrackerGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PolyTrackerGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PolyTrackerActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PolyTrackerGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PolyTrackerGoal()
    }
...
module.exports = PolyTrackerActionGoal;
