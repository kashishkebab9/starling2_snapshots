...
class LissajousTrackerResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LissajousTrackerResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LissajousTrackerResult(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = LissajousTrackerResult;
