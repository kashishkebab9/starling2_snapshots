...
class CircleTrackerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CircleTrackerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CircleTrackerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CircleTrackerActionFeedback(null);
    ...
    data.feedback = CircleTrackerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CircleTrackerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CircleTrackerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CircleTrackerFeedback()
    }
...
module.exports = CircleTrackerActionFeedback;
