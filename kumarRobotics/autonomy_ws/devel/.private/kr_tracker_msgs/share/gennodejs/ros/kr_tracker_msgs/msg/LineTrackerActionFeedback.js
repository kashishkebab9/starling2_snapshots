...
class LineTrackerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LineTrackerFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LineTrackerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LineTrackerActionFeedback(null);
    ...
    data.feedback = LineTrackerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LineTrackerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LineTrackerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LineTrackerFeedback()
    }
...
module.exports = LineTrackerActionFeedback;
