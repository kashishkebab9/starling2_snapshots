...
class LineTrackerActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new LineTrackerResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LineTrackerResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LineTrackerActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = LineTrackerResult.Resolve(msg.result)
    }
    else {
      resolved.result = new LineTrackerResult()
    }
...
module.exports = LineTrackerActionResult;
