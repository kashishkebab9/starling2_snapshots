...
class LissajousAdderActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LissajousAdderFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LissajousAdderFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LissajousAdderActionFeedback(null);
    ...
    data.feedback = LissajousAdderFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LissajousAdderActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LissajousAdderFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LissajousAdderFeedback()
    }
...
module.exports = LissajousAdderActionFeedback;
