...
class TrajectoryTrackerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryTrackerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryTrackerFeedback(null);
...
module.exports = TrajectoryTrackerFeedback;
