...
"""autogenerated by genpy from kr_tracker_msgs/PolyTrackerActionResult.msg. Do not edit."""
import codecs
import sys
...
class PolyTrackerActionResult(genpy.Message):
  _md5sum = "8e81316ec8b012e8e1108ab51d71c75d"
  _type = "kr_tracker_msgs/PolyTrackerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/PolyTrackerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PolyTrackerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kr_tracker_msgs.msg.PolyTrackerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kr_tracker_msgs.msg.PolyTrackerResult()
