...
"""autogenerated by genpy from kr_tracker_msgs/VelocityTrackerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class VelocityTrackerActionFeedback(genpy.Message):
  _md5sum = "ee3397b25d95045a89c45f081d0f7297"
  _type = "kr_tracker_msgs/VelocityTrackerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/VelocityTrackerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelocityTrackerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kr_tracker_msgs.msg.VelocityTrackerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kr_tracker_msgs.msg.VelocityTrackerFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.duration,) = _get_struct_d().unpack(str[start:end])
      return self
