...
"""autogenerated by genpy from kr_tracker_msgs/TrajectoryTrackerAction.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryTrackerAction(genpy.Message):
  _md5sum = "12a0fe871446823d31e1d4c52060dcb9"
  _type = "kr_tracker_msgs/TrajectoryTrackerAction"
...
"""
  ...
  _slot_types = ['kr_tracker_msgs/TrajectoryTrackerActionGoal','kr_tracker_msgs/TrajectoryTrackerActionResult','kr_tracker_msgs/TrajectoryTrackerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajectoryTrackerAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kr_tracker_msgs.msg.TrajectoryTrackerActionGoal()
      if self.action_result is None:
        self.action_result = kr_tracker_msgs.msg.TrajectoryTrackerActionResult()
      if self.action_feedback is None:
        self.action_feedback = kr_tracker_msgs.msg.TrajectoryTrackerActionFeedback()
    else:
      self.action_goal = kr_tracker_msgs.msg.TrajectoryTrackerActionGoal()
      self.action_result = kr_tracker_msgs.msg.TrajectoryTrackerActionResult()
      self.action_feedback = kr_tracker_msgs.msg.TrajectoryTrackerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.action_goal.goal.waypoint_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.waypoint_times))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.waypoint_times = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.waypoint_times.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.waypoint_times = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
