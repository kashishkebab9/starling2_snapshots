...
"""autogenerated by genpy from kr_tracker_msgs/LineTrackerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LineTrackerActionFeedback(genpy.Message):
  _md5sum = "d14b0f8aa21f96bdee6e28f2b0a80fd5"
  _type = "kr_tracker_msgs/LineTrackerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/LineTrackerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LineTrackerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kr_tracker_msgs.msg.LineTrackerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kr_tracker_msgs.msg.LineTrackerFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.distance_from_goal
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.distance_from_goal,) = _get_struct_d().unpack(str[start:end])
      return self
