...
"""autogenerated by genpy from kr_tracker_msgs/VelocityTrackerActionResult.msg. Do not edit."""
import codecs
import sys
...
class VelocityTrackerActionResult(genpy.Message):
  _md5sum = "f12193350ca8054209bc603c43ecc251"
  _type = "kr_tracker_msgs/VelocityTrackerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/VelocityTrackerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelocityTrackerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kr_tracker_msgs.msg.VelocityTrackerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kr_tracker_msgs.msg.VelocityTrackerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_4dB2d().pack(_x.result.vx, _x.result.vy, _x.result.vz, _x.result.vyaw, _x.result.use_position_gains, _x.result.duration, _x.result.length))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.vx, _x.result.vy, _x.result.vz, _x.result.vyaw, _x.result.use_position_gains, _x.result.duration, _x.result.length,) = _get_struct_4dB2d().unpack(str[start:end])
      self.result.use_position_gains = bool(self.result.use_position_gains)
      return self
