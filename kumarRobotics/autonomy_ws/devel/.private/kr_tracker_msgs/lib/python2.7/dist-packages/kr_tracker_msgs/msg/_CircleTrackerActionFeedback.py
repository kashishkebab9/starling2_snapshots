...
"""autogenerated by genpy from kr_tracker_msgs/CircleTrackerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CircleTrackerActionFeedback(genpy.Message):
  _md5sum = "ee3397b25d95045a89c45f081d0f7297"
  _type = "kr_tracker_msgs/CircleTrackerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/CircleTrackerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CircleTrackerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kr_tracker_msgs.msg.CircleTrackerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kr_tracker_msgs.msg.CircleTrackerFeedback()
