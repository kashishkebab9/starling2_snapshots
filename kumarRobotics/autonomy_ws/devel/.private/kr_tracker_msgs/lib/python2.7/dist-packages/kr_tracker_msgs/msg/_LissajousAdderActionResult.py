...
"""autogenerated by genpy from kr_tracker_msgs/LissajousAdderActionResult.msg. Do not edit."""
import codecs
import sys
...
class LissajousAdderActionResult(genpy.Message):
  _md5sum = "746ee2abc66cb4e9f0b0a60fdaec7d5e"
  _type = "kr_tracker_msgs/LissajousAdderActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/LissajousAdderResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LissajousAdderActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kr_tracker_msgs.msg.LissajousAdderResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kr_tracker_msgs.msg.LissajousAdderResult()
