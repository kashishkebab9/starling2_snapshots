...
"""autogenerated by genpy from kr_tracker_msgs/PolyTrackerActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PolyTrackerActionFeedback(genpy.Message):
  _md5sum = "8b217512b87af56bbcd8ae598d9aa52b"
  _type = "kr_tracker_msgs/PolyTrackerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/PolyTrackerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PolyTrackerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = kr_tracker_msgs.msg.PolyTrackerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = kr_tracker_msgs.msg.PolyTrackerFeedback()
