...
"""autogenerated by genpy from kr_tracker_msgs/CircleTrackerActionResult.msg. Do not edit."""
import codecs
import sys
...
class CircleTrackerActionResult(genpy.Message):
  _md5sum = "e004ace7756a7532a2e3ee12b5f76b23"
  _type = "kr_tracker_msgs/CircleTrackerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','kr_tracker_msgs/CircleTrackerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CircleTrackerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = kr_tracker_msgs.msg.CircleTrackerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = kr_tracker_msgs.msg.CircleTrackerResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.result.duration, _x.result.length))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.duration, _x.result.length,) = _get_struct_2d().unpack(str[start:end])
      return self
